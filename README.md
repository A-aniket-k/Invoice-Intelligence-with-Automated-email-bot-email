...
🚀 **[Live Streamlit Web Application](https://invoice-intelligence-with-automated-email-bot-email-bkhifksjmr.streamlit.app/)**
...
* **Phase 2 (Scalability):** Added Pandas-driven bulk dataset processing and file uploading to handle corporate-scale data. [Explore Phase 2 Repo](https://github.com/A-aniket-k/Invoice-Intelligence)
* **Phase 3 (Automation):** Integrated automated SMTP reporting loops to segment data and email actionable alerts. [Explore Phase 3 Repo](https://github.com/A-aniket-k/Invoice-Intelligence-With-Automated-Email-)
